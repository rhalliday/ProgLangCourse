...
let
    val LineSegment(a1,b1,a2,b2) = (eval_prog
    (Shift(5.0,~1.0,LineSegment(1.0,2.0,3.0,4.0)), []))
    val LineSegment(c1,d1,c2,d2) = LineSegment(6.0,1.0,8.0,3.0)
in
    if real_equal(a1,c1) andalso real_equal(a2,c2) andalso real_equal(b1,d1)
  andalso real_equal(b2,d2)
    then (print "Shift of line segment is working properly\n")
    else (print "Shift of line segment is not working properly\n")
end;
